...
//    String authoriseGetAccessPrivilegeForRequest(String projectId, String userId);
     ...
     */
    ResourceResponse newResource(ProjectResourceRequest dto);
     ...
     * @return
     */
    ResourceResponse deleteResource(String resourceId);
     ...
     * @return
     */
    ResourceResponse transferOwnership(String resourceId, String newOwnerId);
}
